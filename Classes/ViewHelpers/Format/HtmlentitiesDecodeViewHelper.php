 ...
 * @api
 */
class Tx_PhzHresregistration_ViewHelpers_Format_HtmlentitiesDecodeViewHelper extends Tx_PhzHresregistration_ViewHelpers_Format_AbstractEncodingViewHelper {
